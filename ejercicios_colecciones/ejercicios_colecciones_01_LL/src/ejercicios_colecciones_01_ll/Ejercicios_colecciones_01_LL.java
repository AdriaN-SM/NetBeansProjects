...
package ejercicios_colecciones_01_ll;
 ...
 *
 * @since 01.04.2022
 * Fecha de modificación: 01.04.2022
 * @author Adrian Solanas
 */
public class Ejercicios_colecciones_01_LL {
    ...
    public static void main(String[] args) {
        ...
        List<Producto> listaProd = new LinkedList<>();
    ...
    public static void visualizar(List listaProd) {
        int i=1;
